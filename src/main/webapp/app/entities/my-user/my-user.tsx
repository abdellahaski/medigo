            ...
            <tbody>
              {myUserList.map((myUser, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{myUser.doctorCabinet ? <Link to={`cabinet/${myUser.doctorCabinet.id}`}>{myUser.doctorCabinet.id}</Link> : ''}</td>
                  <td>
                    {myUser.assistantCabinet ? <Link to={`cabinet/${myUser.assistantCabinet.id}`}>{myUser.assistantCabinet.id}</Link> : ''}
                  </td>
