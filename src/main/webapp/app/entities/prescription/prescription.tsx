  ...
  return (
    <div>
      <h2 id="prescription-heading">
        <Translate contentKey="mediGoApp.prescription.home.title">Prescriptions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="mediGoApp.prescription.home.createLabel">Create new Prescription</Translate>
        </Link>
      </h2>
        ...
        {prescriptionList && prescriptionList.length > 0 ? (
            ...
            <tbody>
              {prescriptionList.map((prescription, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={prescription.date} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="mediGoApp.prescription.home.notFound">No Prescriptions found</Translate>
            </div>
          )
        )}
      </div>
