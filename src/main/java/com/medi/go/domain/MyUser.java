...
public class MyUser implements Serializable {
    ...
    private Cabinet doctorCabinet;

    @DBRef
    @Field("assistantCabinet")
    @JsonIgnoreProperties("assistants")
    private Cabinet assistantCabinet;
    ...
    public Cabinet getDoctorCabinet() {
        return doctorCabinet;
    }

    public MyUser doctorCabinet(Cabinet cabinet) {
        this.doctorCabinet = cabinet;
        return this;
    }

    public void setDoctorCabinet(Cabinet cabinet) {
        this.doctorCabinet = cabinet;
    }

    public Cabinet getAssistantCabinet() {
        return assistantCabinet;
    }

    public MyUser assistantCabinet(Cabinet cabinet) {
        this.assistantCabinet = cabinet;
        return this;
    }

    public void setAssistantCabinet(Cabinet cabinet) {
        this.assistantCabinet = cabinet;
    }
