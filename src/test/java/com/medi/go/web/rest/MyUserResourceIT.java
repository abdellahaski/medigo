...
public class MyUserResourceIT {
    ...
    private static final String DEFAULT_CURRENT_INSURANCE = "AAAAAAAAAA";
    private static final String UPDATED_CURRENT_INSURANCE = "BBBBBBBBBB";
    ...
    public static MyUser createEntity() {
        MyUser myUser = new MyUser()
            ...
            .cin(DEFAULT_CIN)
            .type(DEFAULT_TYPE)
            .currentInsurance(DEFAULT_CURRENT_INSURANCE);
        return myUser;
    }
    /**
    ...
    public static MyUser createUpdatedEntity() {
        MyUser myUser = new MyUser()
            ...
            .cin(UPDATED_CIN)
            .type(UPDATED_TYPE)
            .currentInsurance(UPDATED_CURRENT_INSURANCE);
        return myUser;
    }
    ...
    public void createMyUser() throws Exception {
        ...
        assertThat(testMyUser.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testMyUser.getCurrentInsurance()).isEqualTo(DEFAULT_CURRENT_INSURANCE);
    }
    ...
    public void getAllMyUsers() throws Exception {
        ...
        restMyUserMockMvc.perform(get("/api/my-users?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].currentInsurance").value(hasItem(DEFAULT_CURRENT_INSURANCE)));
    }
    ...
    public void getMyUser() throws Exception {
        ...
        restMyUserMockMvc.perform(get("/api/my-users/{id}", myUser.getId()))
            ...
            .andExpect(jsonPath("$.currentInsurance").value(DEFAULT_CURRENT_INSURANCE));
    }
    ...
    public void updateMyUser() throws Exception {
        ...
        assertThat(testMyUser.getType()).isEqualTo(UPDATED_TYPE);
        assertThat(testMyUser.getCurrentInsurance()).isEqualTo(UPDATED_CURRENT_INSURANCE);
    }
